...
$vecText = ($vecText -join "`n")

Write-Utf8NoBomLf -Path $LawPath   -Text $lawText
Write-Utf8NoBomLf -Path $FinalPath -Text $finalText
Write-Utf8NoBomLf -Path $ChkPath   -Text $chkText
Write-Utf8NoBomLf -Path $ReadmeVec -Text $vecText
...
Write-Host "STAMP_DONE_V2" -ForegroundColor Green
