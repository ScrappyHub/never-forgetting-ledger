...
$Bad = Join-Path $ScriptsDir "_PATCH_echo_outbox_agent_add_heartbeat_receipt_v1.ps1"
...
$Dest = Join-Path $QRoot ("_PATCH_echo_outbox_agent_add_heartbeat_receipt_v1.BAD_" + $stamp + ".ps1")
